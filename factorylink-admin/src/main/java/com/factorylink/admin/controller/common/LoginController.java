package com.factorylink.admin.controller.common;
...
import com.factorylink.domain.common.dto.CurrentLoginUserDTO;
import com.factorylink.domain.common.dto.TokenDTO;
import com.factorylink.domain.system.menu.MenuApplicationService;
import com.factorylink.domain.system.menu.dto.RouterDTO;
import com.factorylink.domain.system.user.UserApplicationService;
import com.factorylink.domain.system.user.command.AddUserCommand;
import com.factorylink.infrastructure.annotations.ratelimit.RateLimit;
import com.factorylink.infrastructure.annotations.ratelimit.RateLimit.CacheType;
import com.factorylink.infrastructure.annotations.ratelimit.RateLimit.LimitType;
...
import com.factorylink.infrastructure.annotations.ratelimit.RateLimitKey;
import com.factorylink.admin.customize.service.login.LoginService;
...
public class LoginController {
    ...
    private final FactoryLinkConfig factoryLinkConfig;
    ...
    public String index() {
        return StrUtil.format("欢迎使用{}后台管理框架，当前版本：v{}，请通过前端地址访问。",
            factoryLinkConfig.getName(), factoryLinkConfig.getVersion());
    }
