package com.factorylink.common.utils.file;
...
class FileUploadUtilsTest {
    ...
    void getFileAbsolutePath() {
        FactoryLinkConfig factoryLinkConfig = new FactoryLinkConfig();
        factoryLinkConfig.setFileBaseDir("D:\\factorylink");

        String fileAbsolutePath = FileUploadUtils.getFileAbsolutePath(UploadSubDir.AVATAR_PATH, "test.jpg");

        Assertions.assertEquals("D:\\factorylink\\profile\\avatar\\test.jpg", fileAbsolutePath);
    }
}
