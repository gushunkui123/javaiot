package com.factorylink.domain.system.role;
...
import com.factorylink.domain.system.role.model.RoleModel;
...
public class RoleApplicationService {
    ...
    public RoleDTO getRoleInfo(Long roleId) {
        ...
        List<Long> selectedDeptList = StrUtil.split(byId.getDeptIdSet(), ",")
            .stream().filter(StrUtil::isNotEmpty).map(Long::valueOf).toList();
