package com.factorylink.domain.system.log;

import com.factorylink.common.core.page.PageDTO;
import com.factorylink.domain.common.command.BulkOperationCommand;
import com.factorylink.domain.system.log.dto.LoginLogDTO;
import com.factorylink.domain.system.log.query.LoginLogQuery;
import com.factorylink.domain.system.log.dto.OperationLogDTO;
import com.factorylink.domain.system.log.query.OperationLogQuery;
import com.factorylink.domain.system.log.db.SysLoginInfoEntity;
import com.factorylink.domain.system.log.db.SysOperationLogEntity;
import com.factorylink.domain.system.log.db.SysLoginInfoService;
import com.factorylink.domain.system.log.db.SysOperationLogService;
