package com.factorylink.domain.system.config;

import com.factorylink.common.core.page.PageDTO;
import com.factorylink.domain.common.cache.CacheCenter;
import com.factorylink.domain.system.config.command.ConfigUpdateCommand;
import com.factorylink.domain.system.config.dto.ConfigDTO;
import com.factorylink.domain.system.config.model.ConfigModel;
import com.factorylink.domain.system.config.model.ConfigModelFactory;
import com.factorylink.domain.system.config.query.ConfigQuery;
import com.factorylink.domain.system.config.db.SysConfigEntity;
