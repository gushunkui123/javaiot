...
import com.factorylink.infrastructure.annotations.ratelimit.implementation.MapRateLimitChecker;
import com.factorylink.infrastructure.annotations.ratelimit.implementation.RedisRateLimitChecker;
...
@Component
@Slf4j
@ConditionalOnExpression("'${factorylink.embedded.redis}' != 'true'")
