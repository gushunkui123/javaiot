...
import com.factorylink.infrastructure.exception.GlobalExceptionFilter;
import com.factorylink.infrastructure.filter.TestFilter;
import com.factorylink.infrastructure.filter.TraceIdFilter;
...
public class FilterConfig {
    ...
    @Value("${factorylink.traceRequestIdKey}")
