...
INSERT INTO  app.sys_dept (dept_id, parent_id, ancestors, dept_name, order_num, leader_id, leader_name, phone, email, status, creator_id, create_time, updater_id, update_time, deleted) VALUES (1, 0, '0', 'FactoryLink科技', 0, null, 'valarchie', '15888888888', 'valarchie@163.com', 1, null, '2022-05-21 08:30:54', null, null, 0);
...
INSERT INTO  app.sys_menu (menu_id, menu_name, menu_type, router_name, parent_id, path, is_button, permission, meta_info, status, remark, creator_id, create_time, updater_id, update_time, deleted) VALUES (4, 'FactoryLink官网', 3, 'FactoryLinkguanwangIframeRouter', 0, '/FactoryLinkguanwangIframeLink', false, '', '{"title":"FactoryLink官网","icon":"ep:link","showParent":true,"frameSrc":"https://element-plus.org/zh-CN/","rank":8}', 1, 'Factorylink官网地址', 0, '2022-05-21 08:30:54', 1, '2023-08-14 23:09:40', 0);
...
INSERT INTO  app.sys_menu (menu_id, menu_name, menu_type, router_name, parent_id, path, is_button, permission, meta_info, status, remark, creator_id, create_time, updater_id, update_time, deleted) VALUES (66, '账号摘要列表', 0, ' ', 5, '', true, 'system:user:summaryList', '{"title":"账号摘要列表"}', 1, '', 0, '2022-05-21 08:30:54', null, null, 0);
...
INSERT INTO  app.sys_menu (menu_id, menu_name, menu_type, router_name, parent_id, path, is_button, permission, meta_info, status, remark, creator_id, create_time, updater_id, update_time, deleted) VALUES (63, 'FactoryLink Github地址', 4, 'https://github.com/valarchie/FactoryLink-Back-End', 0, '/external', false, '', '{"title":"FactoryLink Github地址","icon":"fa-solid:external-link-alt","showParent":true,"rank":9}', 1, 'Factorylink github地址', 0, '2022-05-21 08:30:54', 1, '2023-08-14 23:12:13', 0);
...
INSERT INTO  app.sys_notice (notice_id, notice_title, notice_type, notice_content, status, creator_id, create_time, updater_id, update_time, remark, deleted) VALUES (1, '温馨提醒：2018-07-01 FactoryLink新版本发布啦', 2, '新版本内容~~~~~~~~~~', 1, 1, '2022-05-21 08:30:55', 1, '2022-08-29 20:12:37', '管理员', 0);
INSERT INTO  app.sys_notice (notice_id, notice_title, notice_type, notice_content, status, creator_id, create_time, updater_id, update_time, remark, deleted) VALUES (2, '维护通知：2018-07-01 FactoryLink系统凌晨维护', 1, '维护内容', 1, 1, '2022-05-21 08:30:55', null, null, '管理员', 0);
