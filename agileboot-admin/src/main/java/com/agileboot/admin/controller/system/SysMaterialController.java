...
//import com.agileboot.domain.system.material.MaterialApplicationService;
...
//    @PreAuthorize("@permission.has('system:material:list')")
//    @GetMapping("/list")
...
//    @PreAuthorize("@permission.has('system:material:add')")
...
//    @PreAuthorize("@permission.has('system:material:edit')")
...
//    @PreAuthorize("@permission.has('system:material:remove')")
