package com.agileboot.domain.system.formula;
...
import com.agileboot.domain.system.formula.dto.FormulaDTO;
import com.agileboot.domain.system.formula.dto.FormulaItemDTO;
import com.agileboot.domain.system.formula.model.FormulaModel;
import com.agileboot.domain.system.formula.model.FormulaModelFactory;
import com.agileboot.domain.system.formula.query.FormulaQuery;
...
public class FormulaApplicationService {
    ...
    public PageDTO<FormulaDTO> getFormulaList(FormulaQuery query) {
        Page<SysFormulaEntity> page = formulaService.page(query.toPage(), query.toQueryWrapper());
    ...
    public FormulaDTO getFormulaInfo(Long formulaId) {
        ...
        queryWrapper.eq(SysFormulaItemEntity::getFormulaId, formulaId)
            .orderByAsc(SysFormulaItemEntity::getSortOrder);
        List<SysFormulaItemEntity> itemEntities = formulaItemService.list(queryWrapper);
